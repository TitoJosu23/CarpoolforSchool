...
Revision ID: 7db8bb15c37e
Revises: 2807edd385a2
Create Date: 2022-02-25 19:10:54.080618
...
def upgrade():
    ...
    sa.Column('class_grade', sa.String(length=120), nullable=False),
    ...
    sa.Column('flag_comment', sa.String(length=200), nullable=True),
    ...
    sa.Column('school_address', sa.String(length=80), nullable=False),
    sa.Column('school_logo_url', sa.String(length=80), nullable=False),
    ...
    sa.ForeignKeyConstraint(['blacklisted_guardian_id'], ['guardian.user_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('is_driver', sa.Boolean(create_constraint=80), nullable=False),
    sa.Column('is_available', sa.Boolean(create_constraint=80), nullable=False),
    sa.Column('morning', sa.Boolean(create_constraint=80), nullable=False),
    sa.Column('afternoon', sa.Boolean(create_constraint=80), nullable=False),
    sa.Column('monday', sa.Boolean(create_constraint=80), nullable=False),
    sa.Column('tuesday', sa.Boolean(create_constraint=80), nullable=False),
    sa.Column('wedenesday', sa.Boolean(create_constraint=80), nullable=False),
    sa.Column('thursday', sa.Boolean(create_constraint=80), nullable=False),
    sa.Column('friday', sa.Boolean(create_constraint=80), nullable=False),
    sa.ForeignKeyConstraint(['school_id'], ['school.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
